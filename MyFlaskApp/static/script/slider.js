document.addEventListener('DOMContentLoaded', function() {
    ...
    slideContent = [
        ...
        {"id": 6, "alt": "Kuzey Kıbrıs",  "sports": ["swimming"],                                                   "caption": "İstanbul Technical University in Northern Cyprus (İTÜ-KKTC) aims to cultivate successful, leadership-oriented students and promote inter-university collaboration. The institution strives for regional and global competitiveness, emphasizing a commitment to continuous improvement in education and research processes. The quality policy focuses on enhancing activities systematically, fostering a high-quality environment. İTÜ-KKTC's institutional history highlights its establishment, legislative approvals, and campus development. The corporate identity involves modifying the university emblem, determining color systems, and creating a cohesive visual identity based on a hexagonal pattern.", "transportation": "You can use the ring service between the dormitories and the faculties."}
    ];
